...
var constants_2 = __webpack_require__(13);
...
var Print = __importStar(__webpack_require__(16));
exports.Print = Print;
...
var Link = __importStar(__webpack_require__(17));
exports.Link = Link;
var Pos = __importStar(__webpack_require__(76));
exports.Pos = Pos;
...
function normalizePayload(options) {
    var redirectType = options.redirectType, destination = options.destination;
    var redirectPayload;
    switch (redirectType) {
        default:
        case Redirect_1.Action.APP:
            redirectPayload = Redirect_1.isAppPayload(destination) ? destination : { path: destination };
            break;
        case Redirect_1.Action.ADMIN_PATH:
            redirectPayload = Redirect_1.isAdminPathPayload(destination) ? destination : { path: destination };
            break;
        case Redirect_1.Action.ADMIN_SECTION:
            redirectPayload = Redirect_1.isAdminSectionPayload(destination) ? destination : { section: destination };
            break;
        case Redirect_1.Action.REMOTE:
            redirectPayload = Redirect_1.isRemotePayload(destination) ? destination : { url: destination };
            break;
    }
    return __assign({}, options, { destination: redirectPayload });
}
...
var Link = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Link.prototype, "payload", {
        get: function () {
            var normalizedPayload = normalizePayload(this.options);
            return __assign({ id: this.id }, normalizedPayload);
        },
        enumerable: true,
        configurable: true
    });
...
var helper_1 = __webpack_require__(0);
var Error_1 = __webpack_require__(5);
var Print_1 = __webpack_require__(16);
var MessageTransport_1 = __webpack_require__(12);
var collection_1 = __webpack_require__(9);
var shared_1 = __webpack_require__(45);
var env_1 = __webpack_require__(22);
var print_1 = __webpack_require__(79);
var redirect_1 = __webpack_require__(19);
var types_1 = __webpack_require__(8);
var Hooks_1 = __importDefault(__webpack_require__(80));
...
var validate_1 = __importDefault(__webpack_require__(77));
var utils_1 = __webpack_require__(3);
var redirect_1 = __webpack_require__(19);
    ...
    NavigationMenu.prototype.setItems = function (newOptions) {
        ...
        this.items = this.itemsOptions
            ? this.itemsOptions.map(function (action) {
                _this.addChild(action, _this.group, MENU_LINK_PROPS.subgroups);
                _this.subscribeToChild(action, Link_1.Action.UPDATE, _this.updateItem);
...
Object.defineProperty(exports, "__esModule", { value: true });
var validator_1 = __webpack_require__(78);
...
var actions_1 = __webpack_require__(6);
var Error_1 = __webpack_require__(5);
var actions_2 = __webpack_require__(81);
var type_validate_1 = __webpack_require__(2);
var utils_1 = __webpack_require__(3);
var helper_1 = __webpack_require__(0);
...
exports.Button = Button;
var Scanner = __importStar(__webpack_require__(82));
exports.Scanner = Scanner;
var Cart = __importStar(__webpack_require__(83));
exports.Cart = Cart;
var ContextualSaveBar = __importStar(__webpack_require__(84));
exports.ContextualSaveBar = ContextualSaveBar;
var Fullscreen = __importStar(__webpack_require__(85));
exports.Fullscreen = Fullscreen;
var Loading = __importStar(__webpack_require__(86));
exports.Loading = Loading;
var Modal = __importStar(__webpack_require__(87));
exports.Modal = Modal;
var Navigation = __importStar(__webpack_require__(46));
exports.Navigation = Navigation;
var Print = __importStar(__webpack_require__(89));
exports.Print = Print;
var ButtonGroup = __importStar(__webpack_require__(47));
exports.ButtonGroup = ButtonGroup;
var ResourcePicker = __importStar(__webpack_require__(90));
exports.ResourcePicker = ResourcePicker;
var Toast = __importStar(__webpack_require__(91));
exports.Toast = Toast;
var TitleBar = __importStar(__webpack_require__(92));
exports.TitleBar = TitleBar;
var Menu = __importStar(__webpack_require__(93));
exports.Menu = Menu;
...
var Button_1 = __webpack_require__(4);
var safe_redirect_1 = __webpack_require__(88);
...
var linkOptionsValidator = type_validate_1.matchesObject({ id: type_validate_1.matchesString(), options: link_1.linkSchema });
...
function getPayloadSchema(payload) {
    var baseSchema = type_validate_1.matchesObject({
        items: type_validate_1.makeOptional(type_validate_1.matchesArray(link_1.linkSchemaWithId)),
...
exports.validateProps = validateProps;
function validateAction(action) {
    return type_validate_1.validate(action, utils_1.createActionValidator(actions_1.NavigationMenu.ActionType, getPayloadSchema(action.payload), true, false));
}
exports.validateAction = validateAction;
